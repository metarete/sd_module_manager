...
class ObiettiviController extends AbstractController
{
    ...
    public function index(Request $request, ObiettiviRepository $obiettiviRepository, int $page = 1): Response
    {
        ...
        $obiettivi = $obiettiviRepository->findBy([], array('id' => 'DESC'), $obiettiviPerPagina, $offset);
    ...
    public function disattiva(Obiettivi $obiettivi , ObiettiviRepository $obiettiviRepository): Response
    {
    ...
    public function attiva(Obiettivi $obiettivi , ObiettiviRepository $obiettiviRepository): Response
    {
        $obiettivi->setStato(true);
        $obiettiviRepository->add($obiettivi, true);

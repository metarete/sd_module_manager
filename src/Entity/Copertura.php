...
#[ORM\Entity(repositoryClass: CoperturaRepository::class)]
class Copertura
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToMany(targetEntity: Lesioni::class, mappedBy: 'copertura', cascade:['persist'])]
